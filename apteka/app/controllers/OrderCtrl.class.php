...
class OrderCtrl {
    ...
    public function action_orderAdd() {
        ...
        if($this->form->quantity <= 0 || !is_numeric($this->form->quantity)) Utils::addErrorMessage("Ilość produktów musi być cyfrą większą od zera");
        else{
            ...
            if ((isset($this->form->id_product) && strlen($this->form->id_product) > 0)  && (is_numeric($this->form->quantity)) && strlen($this->form->quantity) > 0) {
                try {
